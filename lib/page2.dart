...
class TrainingDetailed2 extends StatelessWidget {
  const TrainingDetailed2({Key? key});
          ...
          icon: GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const TrainingDetailed2()));
            },
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PreRequirements2()));
            },
            child: Container(
              width: 324,
              height: 50,
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height:
                            5), // Add space between numbered text and bullet points
                    Text(
                    ...
                    SizedBox(
                        height:
                            8), // Add space between numbered text and bullet points
                    Text(
